...
class FixMatchDatasetMapper_Inf:
    """
    ...
    def from_config(cls, cfg, is_train: bool = True):
        ...
        if cfg.FIXMATCH_STRONG_AUG:
            st_augs.append(BBox_Erase(cfg.FIXMATCH_BBOX_ERASE_SCALE_INFERENCE,
    ...
    def __call__(self, dataset_dict):
        ...
        full_box = Boxes(torch.tensor([[instances._image_size[1]//4,instances._image_size[0]//4, 3*instances._image_size[1]//4, 3*instances._image_size[0]//4]]))

        st_aug_input = T.AugInput(st_image, boxes=full_box.tensor, sem_seg=sem_seg_gt)
